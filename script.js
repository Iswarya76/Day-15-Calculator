...
<h1 class=" text-center pt-2 pb-2" id="title" style="color: black">DOM Calculator</h1>
<p id="description" class="text-center pt-2 pb-2" id="title" style="color: black">Calculator with basic function</p>
</div>`;
document.body.append(nav1);
  ...
  firstRow.append(buttonColumns(3, "clear", "CLR", "clear"));
